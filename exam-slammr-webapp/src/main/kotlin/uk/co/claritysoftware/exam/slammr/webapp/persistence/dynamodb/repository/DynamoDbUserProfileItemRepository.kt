...
/**
 * Spring Data Spring Social repository for [UserProfileItem]
 */
@EnableScan
interface DynamoDbUserProfileItemRepository : CrudRepository<UserProfileItem, String> {
	 ...
	 */
	fun findByCompositeUserId(compositeUserId: String): UserProfileItem
}
